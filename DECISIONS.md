...
| 86h | The diagram writes the key **inside the verb**: `(a)dd`, `(t)ake` | It reads as a word and marks the key at once. A bare letter in prose reads as prose, and `a` means a different thing in each box. The keys section leaves them bare, where a column already says what they are | live |
